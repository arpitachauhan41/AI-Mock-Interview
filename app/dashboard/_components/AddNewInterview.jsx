...
function AddNewInterview() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
        ...
        // Log the result to inspect the raw response
        const rawText = result.response.text();
        console.log("Raw Response:", rawText);

        // Check and clean the response for non-JSON text
        ...
        const MockJsonResp = rawText.substring(jsonStartIndex, jsonEndIndex + 1);

        // Parse the cleaned JSON
        const parsedResponse = JSON.parse(MockJsonResp.trim());
